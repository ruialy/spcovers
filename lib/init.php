...
function tend_setup() {
	...
	register_nav_menus(array(
	    'primary_navigation' => __( 'Main Menu', 'tend' ),
	));
...
add_action( 'after_setup_theme', 'tend_setup' );

/**
 * Register sidebars
 */
function tend_widgets_init() {
	register_sidebar(array(
		'name'          => __( 'Primary', 'tend' ),
		'id'            => 'sidebar-primary',
...
add_action( 'widgets_init', 'tend_widgets_init' );
